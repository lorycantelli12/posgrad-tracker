...
export default function CadastroPage() {
  ...
  async function handleContinuar() {
    ...
    if (SUPABASE_CONFIGURED) {
      // Cria sessão anônima real no Supabase — o usuário recebe um UUID válido
      // sem precisar de email/senha. Permite salvar preferências no banco.
    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-gray-900 mt-2">PosGrad Tracker</h1>
        </div>

        <Card className="shadow-lg border-0">
          <CardHeader className="text-center pb-2">
            <CardTitle className="text-2xl">Crie sua conta</CardTitle>
            <CardDescription>Gratuito. Sem cartão de crédito.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 pt-4">
            ...
            <div className="space-y-3">
              <input
                ...
                className="w-full h-10 px-3 rounded-md border border-gray-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-900"
                disabled={loading}
              />
              <input
                type="password"
        ...
        <p className="text-center text-sm text-gray-500 mt-4">
          Já tem conta?{" "}
          <Link href="/dashboard" className="text-blue-900 font-medium hover:underline">
            Entrar
          </Link>
        </p>
      </div>
